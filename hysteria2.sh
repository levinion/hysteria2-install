...
# 修改系统缓冲区大小 - https://v2.hysteria.network/docs/advanced/Performance/
set_buffer_size() {
...
insthysteria() {
	...
	# 服务端设置 - https://v2.hysteria.network/docs/advanced/Full-Server-Config/
...
EOF
	...
	# 客户端设置 - https://v2.hysteria.network/docs/advanced/Full-Client-Config/
